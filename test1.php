<body id = "homePage">
    ...
    <section id="reserve-slots" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="heading text-center">Reserve Your Parking Today</h2>
                ...
                <div class="col-12 d-flex justify-content-center">
                    <div class="parking-building-wrapper">
                        ...
                        <div class="floor active">
                            ...
                            <!-- Outer slots -->
                            <div class="outer-slots-section" id="surface-parking-area">
                                ...
                                <form id="booking-form" class="booking-form-grid">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="extra-services mt-2">
                                        ...
                                        <label class="checkbox-item">
                                            <input type="checkbox" class="extra-service" value="500" data-name="Shuttle One Way" data-group="shuttle">
                                            Shuttle One Way (LKR 500)
                                        </label>

                                        <label class="checkbox-item">
                                            <input type="checkbox" class="extra-service" value="1000" data-name="Shuttle Two Way" data-group="shuttle">
                                    ...
                                    <div class="booking-notes mt-3">
                                        ...
                                        <ul class="whitespace-nowrap">
                                           <li>Please arrive at least <strong>one (1) hour early</strong> to allow time for vehicle handover and necessary procedures.</li>
                                            <li>If the end time is extended, up to <b>2 hours</b> will be <b>waived off</b>, extensions between <b>2 and 8 hours</b> will incur a <b>50%</b> charge, and extensions <b>beyond 8 hours</b> will be <b>charged as a full day</b>.</li>
                                        </ul>
                                    </div>
                                    <button type="submit" id="submit-booking-btn">Reserve Now</button>
                                    <!-- <div class="booking-notes mt-3">
                ...
                <div class="col-md-8">
                    <ul class="booking-tips-timeline">
                        <li>
                            ...
                            <div class="tip-content">Reserve your parking in advance</div>
                        </li>
                        <li>
...
if (extraHours <= 2) {
    ...
    extraServices.forEach(service => {
        service.addEventListener('change', function() {
            // Toggle behavior: if this checkbox belongs to the shuttle group,
            // uncheck the other shuttle option when this one is checked
            if (this.checked && this.dataset.group === 'shuttle') {
                extraServices.forEach(other => {
                    if (other !== this && other.dataset.group === 'shuttle') {
                        other.checked = false;
                    }
                });
            }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            checkBtn.addEventListener('click', () => {
                ...
                if (start !== lastStart || end !== lastEnd) {
                    ...
                    // Scroll to the Surface Parking Area section with offset above
                    setTimeout(() => {
                        const surfaceSection = document.getElementById('surface-parking-area');
                        if (surfaceSection) {
                            const yOffset = -150;
                            const y = surfaceSection.getBoundingClientRect().top + window.pageYOffset + yOffset;
